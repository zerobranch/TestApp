...
import com.github.zerobranch.beebox.training.items.child.DisplayAurallyItem
...
class AurallyTrainingItem(
    ...
    override fun isSameAs(other: Item<*>): Boolean =
        other is AurallyTrainingItem && word.word == other.word.word

    override fun hasSameContentAs(other: Item<*>): Boolean =
        other is AurallyTrainingItem && word == other.word
}