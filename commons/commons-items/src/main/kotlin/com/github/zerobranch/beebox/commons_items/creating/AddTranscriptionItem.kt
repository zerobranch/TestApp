...
class AddTranscriptionItem : BaseBindableItem<CommonItemAddSimpleBinding>() {
    ...
    override fun isSameAs(other: Item<*>): Boolean = other is AddTranscriptionItem

    override fun hasSameContentAs(other: Item<*>): Boolean = other is AddTranscriptionItem
}