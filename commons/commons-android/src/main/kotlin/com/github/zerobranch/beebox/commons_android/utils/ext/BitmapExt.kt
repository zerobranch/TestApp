...
fun Bitmap.isBlank(): Boolean {
    val emptyBitmap = Bitmap.createBitmap(width, height, config)
    return sameAs(emptyBitmap)
}

fun Bitmap.byteArrayOutputStream(): ByteArrayOutputStream =
...
suspend fun Bitmap.blur(
    ...
    if (this@blur.isRecycled) return@withContext null
